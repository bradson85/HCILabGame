...
<form id= "inputs" class= 'inputs'  method = 'POST' action = inc-categories.php<?php echo"?name=".urlencode($_GET['name'])."&gamename=".urlencode($_GET["gamename"]). "&round=".urlencode('Jeopardy').""?>>
...
<p id = "subtitle"> Enter Categories: </p><p id = "subsubtitle"> (Maximum 25 Characters)</p>
...
<input type= "button" id = "backbuttons" name = 'backbuttons 'value = "Contestants">
	...
	<input type = "submit" id = "nextbuttons" name ='nextbuttons' value = "Double Jeopardy Categories">
</div>
</form>
